...
{
  "gitBranch" : "main",
  "gitUrl" : "https://github.com/aullom1/spring-sensors-rabbit.git",
  "projectName" : "spring-sensors-rabbit",
  "publisherRepository" : "acrtmc.azurecr.io/tap-demo/spring-sensors-publisher",
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [https://github.com/tanzu-end-to-end/spring-sensors.git->https://github.com/a...(truncated), main->main]
...
┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [dev.local/spring-sensors-publisher->acrtmc.azurecr.io/ta...(truncated)]
